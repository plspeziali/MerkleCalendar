...
var MerkleCalendar = /** @class */ (function () {
    function MerkleCalendar() {
        ...
        this._closed = new InternalCalendar_1.InternalCalendar('Closed', 0, null);
        this._open = new InternalCalendar_1.InternalCalendar('Open', 0, null);
    }
    Object.defineProperty(MerkleCalendar.prototype, "closed", {
        get: function () {
            return this._closed;
        },
        enumerable: false,
    ...
    Object.defineProperty(MerkleCalendar.prototype, "open", {
        get: function () {
            return this._open;
        },
        enumerable: false,
    ...
    MerkleCalendar.prototype.getBSPRoot = function (hash, oHash, cHash) {
        var findC = this._closed.findNode(hash);
        var findO = this._open.findNode(hash);
        var closed = false;
        var node = null;
        if (findC != null) {
            node = findC;
    ...
    MerkleCalendar.prototype.getLeaves = function () {
        ...
        var openA = [];
        var closedA = [];
        for (var _i = 0, _a = this._open.children; _i < _a.length; _i++) {
            year = _a[_i];
            year = year;
        ...
        for (var _f = 0, _g = this._closed.children; _f < _g.length; _f++) {
            year = _g[_f];
            year = year;
    ...
    MerkleCalendar.prototype.getOCRoots = function () {
        var cHash = this._closed.hash;
        var oHash = this._open.hash;
        if (cHash == null) {
            if (oHash == null) {
                return [null, null];
            }
    ...
    MerkleCalendar.prototype.deserializeMC = function (json) {
        ...
        for (var _i = 0, _a = tree.openRoot; _i < _a.length; _i++) {
            var y = _a[_i];
            for (var _b = 0, _c = y.children; _b < _c.length; _b++) {
                ...
                for (var _d = 0, _e = m.children; _d < _e.length; _d++) {
                    var l = _e[_d];
                    var suList = [];
                    for (var _f = 0, _g = l.storageGroup.map; _f < _g.length; _f++) {
                        var su = _g[_f];
        ...
        for (var _h = 0, _j = tree.closedRoot; _h < _j.length; _h++) {
            var y = _j[_h];
            for (var _k = 0, _l = y.children; _k < _l.length; _k++) {
                ...
                for (var _m = 0, _o = m.children; _m < _o.length; _m++) {
                    var l = _o[_m];
                    var suList = [];
                    for (var _p = 0, _q = l.storageGroup.map; _p < _q.length; _p++) {
                        var su = _q[_p];
                        suList.push(new StorageUnit_1.StorageUnit(su.hash, su.uuid));
                    }
                    var sg = new StorageGroup_1.StorageGroup(l.storageGroup.hash, suList);
